...
export default function FileViewer({ activeIndex }) {
  ...
  return (
    <div className="w-full max-w-[60%] z-[999]">
      {/*Container */}
      <div className="flex justify-center items-center z-[999]">
        {files[activeIndex].type === "IMAGE" ? (
          ...
          <video
            src={files[activeIndex].fileData}
            controls
            className="max-w-[80%] object-contain hview z-[999]"
          ></video>
        ) : (
          <div className="min-w-full hview flex flex-col items-center justify-center z-[999]">
            {/* File Icon Image */}
            <img
            ...
            />
            {/*No preview text*/}
            <h1 className="dark:text-dark_text_2 text-2xl z-[999]">
              No preview available
            </h1>
            {/*File size / type*/}
            <span className="dark:text-dark_text_2 z-[999]">
