      ...
      >
        ...
        <div className="flex flex-col items-center mt-12 gap-1 w-full">
           <p className="text-sm dark:text-black">{contact._id}</p>
             ...
             {/**/}
              <span className="text-xs dark:text-gold">{contact.online ? "" : ""}</span>
          ...
          <h1 className="font-bold text-lg dark:text-gold">{contact.marca}</h1>
          <h1 className="font-bold text-lg dark:text-blue-600">{contact.cor}</h1>
          <h1 className="font-bold text-lg dark:text-red-700">{contact.placa}</h1>
          ...
          <div className="w-full mt-4 px-4">
            <strong className="block text-white text-md text-center mb-2">
...
//envia ao contact seu pedido a ale
const ContactMotoristaWithContext = (props) => (
  <SocketContext.Consumer>
    {(socket) => <ContactMotorista {...props} socket={socket} />}
  </SocketContext.Consumer>
);

export default ContactMotoristaWithContext;
