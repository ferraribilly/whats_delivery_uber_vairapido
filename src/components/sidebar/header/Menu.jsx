...
export default function Menu({ setShowMinhaConta,setShowMap, setShowSobreUsoApp, setShowCardapioOnlines, setShowContratoUber, Test  }) {
...
{/*         
         <li
          className="py-3 pl-5 cursor-pointer hover:bg-dark_bg_3 flex items-center gap-2"
          onClick={() => setShowContratoUber(true)}
        >
          <MinhaContaIcon className="dark:fill-dark_svg_1 w-6 h-6" />
          <span>Contrato Uber</span>
        </li> */}
