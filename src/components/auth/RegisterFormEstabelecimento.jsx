...
export default function RegisterForm() {
  ...
  const onSubmit = async (data) => {
    ...
    if (picture) {
      //upload to cloudinary and then register estabelecimento
      ...
      let res = await dispatch(registerEstabelecimento({ ...data, picture: "" }));
      if (res?.payload?.estabelecimento) {
        navigate("/");
      }
    }
  };
      ...
      <div className="w-full max-w-md space-y-8 p-10 dark:bg-dark_bg_2 rounded-xl">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-6">
          <AuthInput
            ...
            registerEstabelecimento={registerEstabelecimento}
          ...
          <AuthInput
            name="status"
            type="text"
            placeholder="Tipo Comercio (Restaurantes,Delivery,Lojas,Outros)"
            registerEstabelecimento={registerEstabelecimento}
          ...
          <AuthInput
            ...
            registerEstabelecimento={registerEstabelecimento}
            error={errors?.estabelecimento?.message}
          />
          {/* Picture Rg Frente */}
          <Picture
